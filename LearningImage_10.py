...
windows =  slide_window(test_img,
                        ...
                        y_start_stop=[400, None], #tune the parameters
                        xy_window=(128, 128),
                        xy_overlap=(0.9, 0.9))
...
car_windows1 =  slide_window(test_img,
                        x_start_stop=[200, None],
                        y_start_stop=[400, 600], #tune the parameters
                        xy_window=(64, 64),
                        xy_overlap=(0.5, 0.5))
car_windows2 =  slide_window(test_img,
                        x_start_stop=[200, None],
                        y_start_stop=[400, 650], #tune the parameters
                        xy_window=(96, 96),
                        xy_overlap=(0.7, 0.7))
car_windows3 =  slide_window(test_img,
                        x_start_stop=[200, None],
                        y_start_stop=[400, None], #tune the parameters
                        xy_window=(128, 128),
                        xy_overlap=(0.9, 0.9))
...
bboxlist.append(car_windows3)
bboxlist = [item for sublist in bboxlist for item in sublist]

window_img = draw_boxes(test_img, bboxlist)
plt.imshow(window_img);
matplotlib.rc('xtick', labelsize=15) 
matplotlib.rc('ytick', labelsize=15)
plt.title('Sliding Windows Technique:', fontsize=15);
...
#................................
# test 3 : recherche des voiture avec points chauds
#
...
for i in range(4,13):
    ...
    windows =  car_windows3 =  slide_window(test_img,
                        x_start_stop=[200, None],
                        y_start_stop=[400, None], #tune the parameters
                        xy_window=(128, 128),
                        xy_overlap=(0.9, 0.9))
    ...
    #etape 2 :  recherche avec fenetre moyenne 96*96
    windows =  slide_window(test_img,
                        x_start_stop=[200, None],
                        y_start_stop=[400, 650], #tune the parameters
                        xy_window=(96, 96),
    ...
    #etape 3 :  recherche avec fenetre moyenne 64*64
    windows =  slide_window(test_img,
                        x_start_stop=[200, None],
                        y_start_stop=[400, 600], #tune the parameters
                        xy_window=(64, 64),
                        xy_overlap=(0.5, 0.5))
    car_windows3 = search_windows(image, windows, clf, 
                            X_scaler,
                            color_space=color_space, 
                            spatial_size=spatial_size, 
                            hist_bins=hist_bins, 
...
def Video_Pipeline(image):   
    ...
    windows =  slide_window(test_img,
                        x_start_stop=[200, None],
                        y_start_stop=[350, 650], #tune the parameters
                        xy_window=(96, 96),
                        xy_overlap=(0.7, 0.7))
    car_windows2 = search_windows(image, windows, clf, 
                            X_scaler,
    ...
    #etape 2bis :  recherche avec fenetre moyenne 64*64
    windows =  slide_window(test_img,
                        x_start_stop=[200, None],
                        y_start_stop=[300, 550], #tune the parameters
                        xy_window=(64, 64),
                        xy_overlap=(0.5, 0.5))
    car_windows3 = search_windows(image, windows, clf, 
                            X_scaler,
    ...
    heatmap3 = apply_threshold(heatmapcombined,5) # à régler /!\ 10 images
...
test_output = "project_short_output_04.mp4"
clip = VideoFileClip("project_short.mp4")
test_clip = clip.fl_image(Video_Pipeline)
test_clip.write_videofile(test_output, audio=False)

test_output = "project_video_output_09.mp4"
